    ...
    <div class="col-md-8 col-lg-6">
        <div class="custom-card">
            <div class="custom-card-header text-center border-bottom-0 pb-0">
                <div class="d-inline-flex justify-content-center align-items-center bg-success text-white rounded-circle mb-3 shadow" style="width: 70px; height: 70px;">
                    <i class="fas fa-sign-out-alt fa-2x"></i>
                </div>
                <h4 class="font-weight-bold text-dark">Presensi Pulang</h4>
                <p class="text-muted small">Terima kasih atas kerja keras Anda hari ini</p>
            </div>
            <div class="custom-card-body pt-2">
                <form action="{{ route('user.presensi.pulang') }}" method="POST">
                    @csrf
                    @method('put')
